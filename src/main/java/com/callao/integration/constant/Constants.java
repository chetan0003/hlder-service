...
public class Constants {
	...
	public static final String TRB_ACCESS_API_KEY = "ACCESS_API_KEY";
	public static final String TRB_API_VERSION = "API_VERSION";
	public static final String TRB_API_URL = "TRB_API_URL";
}
